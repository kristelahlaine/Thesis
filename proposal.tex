...
This study intends to translate into an algorithm the description of \cite{Harrysson} in reducing a Sudoku problem to its Exact Cover equivalent and to investigate how this reduction translates to better practical runtime performances of solving Sudoku.
